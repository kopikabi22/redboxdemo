              ...
              {filteredPOs.length === 0 ? (
                <tr>
                  <td colSpan={8} className="py-10 text-center text-text-faint">
                    Belum ada Purchase Order yang sesuai kriteria.
                  </td>
                </tr>
              ) : (
                filteredPOs.map((po) => {
                  ...
                  return (
                    <tr key={po.id} className="hover:bg-surface-2/60">
                      <td className="px-3.5 py-2.5 font-mono font-bold text-gold-bright">{po.poNumber}</td>
                      <td className="px-3.5 py-2.5 text-text-muted">{po.orderDate}</td>
                      <td className="px-3.5 py-2.5 font-medium text-text">{br?.name ?? po.branchId}</td>
                      <td className="px-3.5 py-2.5 font-semibold text-text">{po.supplierName}</td>
                      <td className="px-3.5 py-2.5 text-right font-mono font-bold text-text">
                        {formatRupiah(po.totalAmount)}
                      </td>
                      <td className="px-3.5 py-2.5 text-text-muted">{po.paymentTerms}</td>
                      <td className="px-3.5 py-2.5">{getStatusBadge(po.status)}</td>
