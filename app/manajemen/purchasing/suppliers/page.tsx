                ...
                filteredSuppliers.map((supplier) => (
                  <tr key={supplier.id} className="hover:bg-surface-2/60">
                    <td className="px-3.5 py-2.5">
                      ...
                      {supplier.notes && <div className="text-[10px] italic text-text-faint">{supplier.notes}</div>}
                    </td>
                    <td className="px-3.5 py-2.5 font-medium text-text">{supplier.contactPerson}</td>
                    <td className="px-3.5 py-2.5 font-mono text-gold-bright">
                      {supplier.phone}
                      {supplier.email && <div className="text-[10px] text-text-muted">{supplier.email}</div>}
                    </td>
                    <td className="max-w-xs px-3.5 py-2.5 truncate text-text-muted">{supplier.address}</td>
                    <td className="px-3.5 py-2.5">
                      <Badge tone="gold">{supplier.paymentTerms}</Badge>
                    </td>
                    <td className="px-3.5 py-2.5">
                      {supplier.isActive ? (
