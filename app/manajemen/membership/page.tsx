            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {rewards.length === 0 ? (
                  ...
                  rewards.map((reward) => (
                    <tr key={reward.id} className="border-b border-border last:border-b-0">
                      <td className="px-3 py-2 font-semibold">{reward.name}</td>
                      <td className="px-3 py-2">{reward.pointsCost} pts</td>
                      <td className="px-3 py-2 text-text-muted">{reward.description || "-"}</td>
                      <td className="px-3 py-2">
                        <Badge tone={reward.active ? "ok" : "neutral"}>{reward.active ? "Aktif" : "Nonaktif"}</Badge>
                      </td>
                      <td className="px-3 py-2">
